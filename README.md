...
例えば「誤情報・誤誘導」であれば、入力や参照情報と整合し、虚偽・誤りや利用者の誤認につながる内容を含まない状態を完了条件としました。
...
- 評価区分の階層と、各区分に対する完了条件
- 完了条件から評価観点、評価基準、合格基準へ進む順番
- 成果物のフォーマット
- `完了条件No → 観点No`で前後の工程を結び付ける方法

一方、次の内容は案件ごとに判断するようにしました。

- 各完了条件を評価対象にするか、対象外にするか、その判断理由
- 具体的な評価観点と観点の説明
- 5段階それぞれの具体的な評価基準
- 合格とする平均点や、重大なNGの扱い

実際には、[完了条件シート・観点シート・仕様書の3つのFMT](https://github.com/ziriss8120121/llm-output-evaluation-guideline/tree/main/templates)を用意しました。
